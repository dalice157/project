...
import { saveTopForm, loadUserInfo } from '../../../actions/basic';
import JoinTutorForm from '../../../components/demand_v3/joinCaseForm/JoinTutorForm';
import {
  tutorRoleTypes, personTypeOpts, moneyData, sexTitle
...
class JoinPublishTutorForm extends PureComponent {
  state = {
    isSubmitting: false,
  }
  ...
  initializeData = (initialCaseForm, enableUserData, area) => {
    const { assignPlace, demandCategory } = initialCaseForm;
    const {
    ...
    const initialData = {
      ...
      enableUserData: {
        ...
        birthday: moment(birthday || '1900/01/01', acDateFormat),
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(JoinPublishTutorForm));
