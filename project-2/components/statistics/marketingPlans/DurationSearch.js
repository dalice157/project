...
class DateSearch extends PureComponent {
  ...
  disabledStartDate = (pickedDate, endDate) => {
    return endDate.valueOf() < pickedDate.valueOf() || dayjs().valueOf() < pickedDate.valueOf();
  };

  disabledEndDate = (pickedDate, startDate) => {
    return startDate.valueOf() < pickedDate.valueOf() || dayjs().valueOf() < pickedDate.valueOf();
  };
