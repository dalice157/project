...
const PlansTable = ({ dates, plansTable, isCompared }) => {
        ...
        <table className="plans-table">
          <tbody>
            ...
            <tr>
              ...
              <td>-</td>
              <td>
                <p>{(target.newPurchaseCount && target.newPurchaseCount[productNoList.valuableNo]) !== null ? target.newPurchaseCount[productNoList.valuableNo] : '-'}</p>
                <p>
                  (
                  {(target.newTrailPurchaseCount && target.newTrailPurchaseCount[productNoList.valuableNo]) !== null ? target.newTrailPurchaseCount[productNoList.valuableNo] : '-'}
                  )
                </p>
              </td>
              <td>-</td>
              <td>-</td>
              <td>
                <p>{(target.newPurchaseCount && target.newPurchaseCount[productNoList.value365No]) !== null ? target.newPurchaseCount[productNoList.value365No] : '-'}</p>
                <p>
                  (
                  {(target.newTrailPurchaseCount && target.newTrailPurchaseCount[productNoList.value365No]) !== null ? target.newTrailPurchaseCount[productNoList.value365No] : '-'}
                  )
                </p>
              </td>
              <td>
                <p>{(target.newPurchaseCount && target.newPurchaseCount[productNoList.infiniteNo]) !== null ? target.newPurchaseCount[productNoList.infiniteNo] : '-'}</p>
                <p>
                  (
                  {(target.newTrailPurchaseCount && target.newTrailPurchaseCount[productNoList.infiniteNo]) !== null ? target.newTrailPurchaseCount[productNoList.infiniteNo] : '-'}
                  )
                </p>
              </td>
              <td>-</td>
              <td>-</td>
              <td>
                <p>{(target.newPurchaseCount && target.newPurchaseCount[productNoList.infinite365No]) !== null ? target.newPurchaseCount[productNoList.infinite365No] : '-'}</p>
                <p>
                  (
                  {(target.newTrailPurchaseCount && target.newTrailPurchaseCount[productNoList.infinite365No]) !== null ? target.newTrailPurchaseCount[productNoList.infinite365No] : '-'}
                  )
                </p>
              </td>
              <td>
                <p>{(target.newPurchaseCount && target.newPurchaseCount[productNoList.upgradeMonthNo]) !== null ? target.newPurchaseCount[productNoList.upgradeMonthNo] : '-'}</p>
                <p>
                  (
                  {(target.newTrailPurchaseCount && target.newTrailPurchaseCount[productNoList.upgradeMonthNo]) !== null ? target.newTrailPurchaseCount[productNoList.upgradeMonthNo] : '-'}
                  )
                </p>
              </td>
              <td>
                <p>{(target.newPurchaseCount && target.newPurchaseCount[productNoList.upgradeYearNo]) !== null ? target.newPurchaseCount[productNoList.upgradeYearNo] : '-'}</p>
                <p>
                  (
                  {(target.newTrailPurchaseCount && target.newTrailPurchaseCount[productNoList.upgradeYearNo]) !== null ? target.newTrailPurchaseCount[productNoList.upgradeYearNo] : '-'}
                  )
                </p>
              </td>
            </tr>
            <tr>
              ...
              <td>-</td>
              <td>
                <p>{(compare.newPurchaseCount && compare.newPurchaseCount[productNoList.valuableNo]) !== null ? compare.newPurchaseCount[productNoList.valuableNo] : '-'}</p>
                <p>
                  (
                  {(compare.newTrailPurchaseCount && compare.newTrailPurchaseCount[productNoList.valuableNo]) !== null ? compare.newTrailPurchaseCount[productNoList.valuableNo] : '-'}
                  )
                </p>
              </td>
              <td>-</td>
              <td>-</td>
              <td>
                <p>{(compare.newPurchaseCount && compare.newPurchaseCount[productNoList.value365No]) !== null ? compare.newPurchaseCount[productNoList.value365No] : '-'}</p>
                <p>
                  (
                  {(compare.newTrailPurchaseCount && compare.newTrailPurchaseCount[productNoList.value365No]) !== null ? compare.newTrailPurchaseCount[productNoList.value365No] : '-'}
                  )
                </p>
              </td>
              <td>
                <p>{(compare.newPurchaseCount && compare.newPurchaseCount[productNoList.infiniteNo]) !== null ? compare.newPurchaseCount[productNoList.infiniteNo] : '-'}</p>
                <p>
                  (
                  {(compare.newTrailPurchaseCount && compare.newTrailPurchaseCount[productNoList.infiniteNo]) !== null ? compare.newTrailPurchaseCount[productNoList.infiniteNo] : '-'}
                  )
                </p>
              </td>
              <td>-</td>
              <td>-</td>
              <td>
                <p>{(compare.newPurchaseCount && compare.newPurchaseCount[productNoList.infinite365No]) !== null ? compare.newPurchaseCount[productNoList.infinite365No] : '-'}</p>
                <p>
                  (
                  {(compare.newTrailPurchaseCount && compare.newTrailPurchaseCount[productNoList.infinite365No]) !== null ? compare.newTrailPurchaseCount[productNoList.infinite365No] : '-'}
                  )
                </p>
              </td>
              <td>
                <p>{(compare.newPurchaseCount && compare.newPurchaseCount[productNoList.upgradeMonthNo]) !== null ? compare.newPurchaseCount[productNoList.upgradeMonthNo] : '-'}</p>
                <p>
                  (
                  {(compare.newTrailPurchaseCount && compare.newTrailPurchaseCount[productNoList.upgradeMonthNo]) !== null ? compare.newTrailPurchaseCount[productNoList.upgradeMonthNo] : '-'}
                  )
                </p>
              </td>
              <td>
                <p>{(compare.newPurchaseCount && compare.newPurchaseCount[productNoList.upgradeYearNo]) !== null ? compare.newPurchaseCount[productNoList.upgradeYearNo] : '-'}</p>
                <p>
                  (
                  {(compare.newTrailPurchaseCount && compare.newTrailPurchaseCount[productNoList.upgradeYearNo]) !== null ? compare.newTrailPurchaseCount[productNoList.upgradeYearNo] : '-'}
                  )
                </p>
              </td>
            </tr>
            <tr>
              ...
              <td>-</td>
              <td>
                <p>{(ratio.newPurchaseCount && ratio.newPurchaseCount[productNoList.valuableNo]) !== null ? ratio.newPurchaseCount[productNoList.valuableNo] : '-'}</p>
                <p>
                  (
                  {(ratio.newTrailPurchaseCount && ratio.newTrailPurchaseCount[productNoList.valuableNo]) !== null ? ratio.newTrailPurchaseCount[productNoList.valuableNo] : '-'}
                  %)
                </p>
              </td>
              <td>-</td>
              <td>-</td>
              <td>
                <p>{(ratio.newPurchaseCount && ratio.newPurchaseCount[productNoList.value365No]) !== null ? ratio.newPurchaseCount[productNoList.value365No] : '-'}</p>
                <p>
                  (
                  {(ratio.newTrailPurchaseCount && ratio.newTrailPurchaseCount[productNoList.value365No]) !== null ? ratio.newTrailPurchaseCount[productNoList.value365No] : '-'}
                  %)
                </p>
              </td>
              <td>
                <p>{(ratio.newPurchaseCount && ratio.newPurchaseCount[productNoList.infiniteNo]) !== null ? ratio.newPurchaseCount[productNoList.infiniteNo] : '-'}</p>
                <p>
                  (
                  {(ratio.newTrailPurchaseCount && ratio.newTrailPurchaseCount[productNoList.infiniteNo]) !== null ? ratio.newTrailPurchaseCount[productNoList.infiniteNo] : '-'}
                  %)
                </p>
              </td>
              <td>-</td>
              <td>-</td>
              <td>
                <p>{(ratio.newPurchaseCount && ratio.newPurchaseCount[productNoList.infinite365No]) !== null ? ratio.newPurchaseCount[productNoList.infinite365No] : '-'}</p>
                <p>
                  (
                  {(ratio.newTrailPurchaseCount && ratio.newTrailPurchaseCount[productNoList.infinite365No]) !== null ? ratio.newTrailPurchaseCount[productNoList.infinite365No] : '-'}
                  %)
                </p>
              </td>
              <td>
                <p>{(ratio.newPurchaseCount && ratio.newPurchaseCount[productNoList.upgradeMonthNo]) !== null ? ratio.newPurchaseCount[productNoList.upgradeMonthNo] : '-'}</p>
                <p>
                  (
                  {(ratio.newTrailPurchaseCount && ratio.newTrailPurchaseCount[productNoList.upgradeMonthNo]) !== null ? ratio.newTrailPurchaseCount[productNoList.upgradeMonthNo] : '-'}
                  %)
                </p>
              </td>
              <td>
                <p>{(ratio.newPurchaseCount && ratio.newPurchaseCount[productNoList.upgradeYearNo]) !== null ? ratio.newPurchaseCount[productNoList.upgradeYearNo] : '-'}</p>
                <p>
                  (
                  {(ratio.newTrailPurchaseCount && ratio.newTrailPurchaseCount[productNoList.upgradeYearNo]) !== null ? ratio.newTrailPurchaseCount[productNoList.upgradeYearNo] : '-'}
                  %)
                </p>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>-</td>
              <td>
                <p>{(target.newPurchasePerformance && target.newPurchasePerformance[productNoList.valuableNo]) !== null ? target.newPurchasePerformance[productNoList.valuableNo] : '-'}</p>
                <p>
                  (
                  {(target.newTrailPurchasePerformance && target.newTrailPurchasePerformance[productNoList.valuableNo]) !== null ? target.newTrailPurchasePerformance[productNoList.valuableNo] : '-'}
                  )
                </p>
              </td>
              <td>-</td>
              <td>-</td>
              <td>
                <p>{(target.newPurchasePerformance && target.newPurchasePerformance[productNoList.value365No]) !== null ? target.newPurchasePerformance[productNoList.value365No] : '-'}</p>
                <p>
                  (
                  {(target.newTrailPurchasePerformance && target.newTrailPurchasePerformance[productNoList.value365No]) !== null ? target.newTrailPurchasePerformance[productNoList.value365No] : '-'}
                  )
                </p>
              </td>
              <td>
                <p>{(target.newPurchasePerformance && target.newPurchasePerformance[productNoList.infiniteNo]) !== null ? target.newPurchasePerformance[productNoList.infiniteNo] : '-'}</p>
                <p>
                  (
                  {(target.newTrailPurchasePerformance && target.newTrailPurchasePerformance[productNoList.infiniteNo]) !== null ? target.newTrailPurchasePerformance[productNoList.infiniteNo] : '-'}
                  )
                </p>
              </td>
              <td>-</td>
              <td>-</td>
              <td>
                <p>{(target.newPurchasePerformance && target.newPurchasePerformance[productNoList.infinite365No]) !== null ? target.newPurchasePerformance[productNoList.infinite365No] : '-'}</p>
                <p>
                  (
                  {(target.newTrailPurchasePerformance && target.newTrailPurchasePerformance[productNoList.infinite365No]) !== null ? target.newTrailPurchasePerformance[productNoList.infinite365No] : '-'}
                  )
                </p>
              </td>
              <td>
                <p>{(target.newPurchasePerformance && target.newPurchasePerformance[productNoList.upgradeMonthNo]) !== null ? target.newPurchasePerformance[productNoList.upgradeMonthNo] : '-'}</p>
                <p>
                  (
                  {(target.newTrailPurchasePerformance && target.newTrailPurchasePerformance[productNoList.upgradeMonthNo]) !== null ? target.newTrailPurchasePerformance[productNoList.upgradeMonthNo] : '-'}
                  )
                </p>
              </td>
              <td>
                <p>{(target.newPurchaseCount && target.newPurchaseCount[productNoList.upgradeYearNo]) !== null ? target.newPurchaseCount[productNoList.upgradeYearNo] : '-'}</p>
                <p>{(target.newPurchasePerformance && target.newPurchasePerformance[productNoList.upgradeYearNo]) !== null ? target.newPurchasePerformance[productNoList.upgradeYearNo] : '-'}</p>
                <p>
                  (
                  {(target.newTrailPurchasePerformance && target.newTrailPurchasePerformance[productNoList.upgradeYearNo]) !== null ? target.newTrailPurchasePerformance[productNoList.upgradeYearNo] : '-'}
                  )
                </p>
              </td>
            </tr>
            <tr>
              ...
              <td>-</td>
              <td>
                <p>{(compare.newPurchasePerformance && compare.newPurchasePerformance[productNoList.valuableNo]) !== null ? compare.newPurchasePerformance[productNoList.valuableNo] : '-'}</p>
                <p>
                  (
                  {(compare.newTrailPurchasePerformance && compare.newTrailPurchasePerformance[productNoList.valuableNo]) !== null ? compare.newTrailPurchasePerformance[productNoList.valuableNo] : '-'}
                  )
                </p>
              </td>
              <td>-</td>
              <td>-</td>
              <td>
                <p>{(compare.newPurchasePerformance && compare.newPurchasePerformance[productNoList.value365No]) !== null ? compare.newPurchasePerformance[productNoList.value365No] : '-'}</p>
                <p>
                  (
                  {(compare.newTrailPurchasePerformance && compare.newTrailPurchasePerformance[productNoList.value365No]) !== null ? compare.newTrailPurchasePerformance[productNoList.value365No] : '-'}
                  )
                </p>
              </td>
              <td>
                <p>{(compare.newPurchasePerformance && compare.newPurchasePerformance[productNoList.infiniteNo]) !== null ? compare.newPurchasePerformance[productNoList.infiniteNo] : '-'}</p>
                <p>
                  (
                  {(compare.newTrailPurchasePerformance && compare.newTrailPurchasePerformance[productNoList.infiniteNo]) !== null ? compare.newTrailPurchasePerformance[productNoList.infiniteNo] : '-'}
                  )
                </p>
              </td>
              <td>-</td>
              <td>-</td>
              <td>
                <p>{(compare.newPurchasePerformance && compare.newPurchasePerformance[productNoList.infinite365No]) !== null ? compare.newPurchasePerformance[productNoList.infinite365No] : '-'}</p>
                <p>
                  (
                  {(compare.newTrailPurchasePerformance && compare.newTrailPurchasePerformance[productNoList.infinite365No]) !== null ? compare.newTrailPurchasePerformance[productNoList.infinite365No] : '-'}
                  )
                </p>
              </td>
              <td>
                <p>{(compare.newPurchasePerformance && compare.newPurchasePerformance[productNoList.upgradeMonthNo]) !== null ? compare.newPurchasePerformance[productNoList.upgradeMonthNo] : '-'}</p>
                <p>
                  (
                  {(compare.newTrailPurchasePerformance && compare.newTrailPurchasePerformance[productNoList.upgradeMonthNo]) !== null ? compare.newTrailPurchasePerformance[productNoList.upgradeMonthNo] : '-'}
                  )
                </p>
              </td>
              <td>
                <p>{(compare.newPurchasePerformance && compare.newPurchasePerformance[productNoList.upgradeYearNo]) !== null ? compare.newPurchasePerformance[productNoList.upgradeYearNo] : '-'}</p>
                <p>
                  (
                  {(compare.newTrailPurchasePerformance && compare.newTrailPurchasePerformance[productNoList.upgradeYearNo]) !== null ? compare.newTrailPurchasePerformance[productNoList.upgradeYearNo] : '-'}
                  )
                </p>
              </td>
            </tr>
            <tr>
              ...
              <td>-</td>
              <td>
                <p>{(ratio.newPurchasePerformance && ratio.newPurchasePerformance[productNoList.valuableNo]) !== null ? convertRate(ratio.newPurchasePerformance[productNoList.valuableNo], true) : '-'}</p>
                <p>
                  (
                  {(ratio.newTrailPurchasePerformance && ratio.newTrailPurchasePerformance[productNoList.valuableNo]) !== null ? convertRate(ratio.newTrailPurchasePerformance[productNoList.valuableNo], true) : '-'}
                  )
                </p>
              </td>
              <td>-</td>
              <td>-</td>
              <td>
                <p>{(ratio.newPurchasePerformance && ratio.newPurchasePerformance[productNoList.value365No]) !== null ? convertRate(ratio.newPurchasePerformance[productNoList.value365No], true) : '-'}</p>
                <p>
                  (
                  {(ratio.newTrailPurchasePerformance && ratio.newTrailPurchasePerformance[productNoList.value365No]) !== null ? convertRate(ratio.newTrailPurchasePerformance[productNoList.value365No], true) : '-'}
                  )
                </p>
              </td>
              <td>
                <p>
                  (
                  {(ratio.newTrailPurchasePerformance && ratio.newTrailPurchasePerformance[productNoList.infiniteNo]) !== null ? convertRate(ratio.newTrailPurchasePerformance[productNoList.infiniteNo], true) : '-'}
                  )
                </p>
              </td>
              <td>-</td>
              <td>-</td>
              <td>
                <p>{(ratio.newPurchasePerformance && ratio.newPurchasePerformance[productNoList.infinite365No]) !== null ? convertRate(ratio.newPurchasePerformance[productNoList.infinite365No], true) : '-'}</p>
                <p>
                  (
                  {(ratio.newTrailPurchasePerformance && ratio.newTrailPurchasePerformance[productNoList.infinite365No]) !== null ? convertRate(ratio.newTrailPurchasePerformance[productNoList.infinite365No], true) : '-'}
                  )
                </p>
              </td>
              <td>
                <p>{(ratio.newPurchasePerformance && ratio.newPurchasePerformance[productNoList.upgradeMonthNo]) !== null ? convertRate(ratio.newPurchasePerformance[productNoList.upgradeMonthNo], true) : '-'}</p>
                <p>
                  (
                  {(ratio.newTrailPurchasePerformance && ratio.newTrailPurchasePerformance[productNoList.upgradeMonthNo]) !== null ? convertRate(ratio.newTrailPurchasePerformance[productNoList.upgradeMonthNo], true) : '-'}
                  )
                </p>
              </td>
              <td>
                <p>{(ratio.newPurchasePerformance && ratio.newPurchasePerformance[productNoList.upgradeYearNo]) !== null ? convertRate(ratio.newPurchasePerformance[productNoList.upgradeYearNo], true) : '-'}</p>
                <p>
                  (
                  {(ratio.newTrailPurchasePerformance && ratio.newTrailPurchasePerformance[productNoList.upgradeYearNo]) !== null ? convertRate(ratio.newTrailPurchasePerformance[productNoList.upgradeYearNo], true) : '-'}
                  )
                </p>
              </td>
            </tr>
  ...
  const {
    newPurchaseCount, newPurchaseRate, newPurchasePerformance, continuePurchaseCount, continuePurchaseRate, continuePurchasePerformance, rePurchaseCount, rePurchaseRate, rePurchasePerformance, againPurchaseCount, againPurchaseRate, againPurchasePerformance, purchaseSumPerformance, productMenu, newTrailPurchaseCount, newTrailPurchasePerformance,
  } = target;
  const targetDateDuration = `${dayjs(targetStartDate).format('YYYY/MM/DD')}～${dayjs(targetEndDate).format('YYYY/MM/DD')}`;
  const productNo = Object.keys(productMenu);
  const productNoList = {
      ...
      <table className="plans-table">
        <tbody>
          ...
          <tr className="plans-header-col">
            ...
            <td>-</td>
            <td>
              <p>{(newPurchaseCount && newPurchaseCount[productNoList.valuableNo]) !== null ? newPurchaseCount[productNoList.valuableNo] : '-'}</p>
              <p>
                (
                {(newTrailPurchaseCount && newTrailPurchaseCount[productNoList.valuableNo]) !== null ? newTrailPurchaseCount[productNoList.valuableNo] : '-'}
                )
              </p>
            </td>
            <td>-</td>
            <td>-</td>
            <td>
              <p>{(newPurchaseCount && newPurchaseCount[productNoList.value365No]) !== null ? newPurchaseCount[productNoList.value365No] : '-'}</p>
              <p>
                (
                {(newTrailPurchaseCount && newTrailPurchaseCount[productNoList.value365No]) !== null ? newTrailPurchaseCount[productNoList.value365No] : '-'}
                )
              </p>
            </td>
            <td>
              <p>{(newPurchaseCount && newPurchaseCount[productNoList.infiniteNo]) !== null ? newPurchaseCount[productNoList.infiniteNo] : '-'}</p>
              <p>
                (
                {(newTrailPurchaseCount && newTrailPurchaseCount[productNoList.infiniteNo]) !== null ? newTrailPurchaseCount[productNoList.infiniteNo] : '-'}
                )
              </p>
            </td>
            <td>-</td>
            <td>-</td>
            <td>
              <p>{(newPurchaseCount && newPurchaseCount[productNoList.infinite365No]) !== null ? newPurchaseCount[productNoList.infinite365No] : '-'}</p>
              <p>
                (
                {(newTrailPurchaseCount && newTrailPurchaseCount[productNoList.infinite365No]) !== null ? newTrailPurchaseCount[productNoList.infinite365No] : '-'}
                )
              </p>

            </td>
            <td>
              <p>{(newPurchaseCount && newPurchaseCount[productNoList.upgradeMonthNo]) !== null ? newPurchaseCount[productNoList.upgradeMonthNo] : '-'}</p>
              <p>
                (
                {(newTrailPurchaseCount && newTrailPurchaseCount[productNoList.upgradeMonthNo]) !== null ? newTrailPurchaseCount[productNoList.upgradeMonthNo] : '-'}
                )
              </p>

            </td>
            <td>
              <p>{(newPurchaseCount && newPurchaseCount[productNoList.upgradeYearNo]) !== null ? newPurchaseCount[productNoList.upgradeYearNo] : '-'}</p>
              <p>
                (
                {(newTrailPurchaseCount && newTrailPurchaseCount[productNoList.upgradeYearNo]) !== null ? newTrailPurchaseCount[productNoList.upgradeYearNo] : '-'}
                )
              </p>
          ...
          <tr>
            ...
            <td>-</td>
            <td>
              <p>{(newPurchasePerformance && newPurchasePerformance[productNoList.valuableNo]) !== null ? newPurchasePerformance[productNoList.valuableNo] : '-'}</p>
              <p>
                (
                {(newTrailPurchasePerformance && newTrailPurchasePerformance[productNoList.valuableNo]) !== null ? newTrailPurchasePerformance[productNoList.valuableNo] : '-'}
                )
              </p>
            </td>
            <td>-</td>
            <td>-</td>
            <td>
              <p>{(newPurchasePerformance && newPurchasePerformance[productNoList.value365No]) !== null ? newPurchasePerformance[productNoList.value365No] : '-'}</p>
              <p>
                (
                {(newTrailPurchasePerformance && newTrailPurchasePerformance[productNoList.value365No]) !== null ? newTrailPurchasePerformance[productNoList.value365No] : '-'}
                )
              </p>
            </td>
            <td>
              <p>{(newPurchasePerformance && newPurchasePerformance[productNoList.infiniteNo]) !== null ? newPurchasePerformance[productNoList.infiniteNo] : '-'}</p>
              <p>
                (
                {(newTrailPurchasePerformance && newTrailPurchasePerformance[productNoList.infiniteNo]) !== null ? newTrailPurchasePerformance[productNoList.infiniteNo] : '-'}
                )
              </p>
            </td>
            <td>-</td>
            <td>-</td>
            <td>
              <p>{(newPurchasePerformance && newPurchasePerformance[productNoList.infinite365No]) !== null ? newPurchasePerformance[productNoList.infinite365No] : '-'}</p>
              <p>
                (
                {(newTrailPurchasePerformance && newTrailPurchasePerformance[productNoList.infinite365No]) !== null ? newTrailPurchasePerformance[productNoList.infinite365No] : '-'}
                )
              </p>
            </td>
            <td>
              <p>{(newPurchaseCount && newPurchasePerformance[productNoList.upgradeMonthNo]) !== null ? newPurchasePerformance[productNoList.upgradeMonthNo] : '-'}</p>
              <p>
                (
                {(newTrailPurchasePerformance && newTrailPurchasePerformance[productNoList.upgradeMonthNo]) !== null ? newTrailPurchasePerformance[productNoList.upgradeMonthNo] : '-'}
                )
              </p>

            </td>
            <td>
              <p>{(newPurchaseCount && newPurchasePerformance[productNoList.upgradeYearNo]) !== null ? newPurchasePerformance[productNoList.upgradeYearNo] : '-'}</p>
              <p>
                (
                {(newTrailPurchasePerformance && newTrailPurchasePerformance[productNoList.upgradeYearNo]) !== null ? newTrailPurchasePerformance[productNoList.upgradeYearNo] : '-'}
                )
              </p>
            </td>
          </tr>
