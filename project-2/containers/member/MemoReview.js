...
class MemoReview extends Component {
  state = {
    postNum: '',
    editing: false,
    loading: false,
  ...
  async componentDidMount() {
    ...
    if (basicId) {
      ...
      this.props.loadMemoList(basicId, '', 'review').then(() => {
        this.setState({
          loading: false,
      ...
      <Spin tip="Loading..." spinning={this.state.loading}>
        ...
        <div className="memoWrap">
          ...
          <div className="memoContent">
            ...
            />
            {
              items.length > 0 ? <TabGig data={items} visible={visible} /> : <div className="noData">無服務評價資料</div>
            }
            {
              cursor
              && (
